...
export default function LakeRunRaceInfo() {
  return (
    <div className='min-h-screen bg-gray-50 text-gray-800'>
      ...
      <div className='max-w-6xl mx-auto px-4 py-8'>
            ...
            <div className='p-6 space-y-4 text-gray-800'>
              ...
              <div className='bg-red-50 border border-red-200 p-3 rounded-lg'>
                <p className='text-red-700 font-semibold text-sm'>
                  ⚠️ Late entries will not be entertained. Cutoff timings will
        ...
        {/* Race Day Schedule */}
        <section className='bg-white rounded-lg shadow-lg p-6 mb-8 text-gray-800'>
 ...
 <div className="mb-4">
    ...
    <ul className='list-disc list-inside text-sm text-black space-y-1 pl-2'>
      <li>✅ Age category determined as on race day (August 10, 2025).</li>
      <li>✅ Carry ID proof (DOB mandatory) for prize eligibility.</li>
      <li>✅ In case of tie or disputes, organiser’s decision is final.</li>
    </ul>
  </div>
          {/* 10K */}
          <div className='mb-6'>
        ...
        <section>
          ...
          <div className='text-sm space-y-2 text-center text-gray-800'>
